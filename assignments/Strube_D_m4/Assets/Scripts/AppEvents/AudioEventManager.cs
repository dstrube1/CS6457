...
public class AudioEventManager : MonoBehaviour
{
    ...
    public AudioClip sphereCollectionAudio;
    ...
    private UnityAction<Vector3> sphereCollectionEventListener;
    ...
    void Awake()
    {
        ...
        sphereCollectionEventListener = new UnityAction<Vector3>(sphereCollectionEventHandler);
    }
    ...
    void OnEnable()
    {
        ...
        EventManager.StartListening<SphereCollectionEvent, Vector3>(sphereCollectionEventListener);
    }
    ...
    void OnDisable()
    {
        ...
        EventManager.StopListening<SphereCollectionEvent, Vector3>(sphereCollectionEventListener);
    }
    ...
    //
    void sphereCollectionEventHandler(Vector3 worldPos)
    {
        //AudioSource.PlayClipAtPoint(this.explosionAudio, worldPos, 1f);
        ...
        if (eventSound3DPrefab)
        {
            ...
            snd.audioSrc.clip = this.sphereCollectionAudio;
