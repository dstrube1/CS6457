...
//Root Motion Control Script for SomeDude_RootMotion
public class RootMotionControlScript : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (rbody.position.y < -10.0f) rbody.position = new Vector3(rbody.position.x, 0.5f, rbody.position.z);
    }
    ...
    void FixedUpdate()
    {
        ...
        //1:25:00 of Unity Interactive Animation lecture
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.transform.gameObject.name == "Boy0"){
            // collision.transform.gameObject.GetComponent<KidsScript>()
            // Set isCollided to true, somehow
            Debug.Log("Collided with Boy0");
        }
    ...
    //From 1:31:00 of Unity Interactive Animation lecture
    ...
    void OnAnimatorMove()
    {
        ...
        //newRootPosition = this.transform.position + this.transform.forward * anim.GetFloat("vely") * rootMovementSpeed * Time.deltaTime;
        //57:00 of Unity Interactive Animation lecture
        newRootPosition = Vector3.LerpUnclamped(this.transform.position, newRootPosition, rootMovementSpeed);//CoPilot suggested this - why?: * Time.deltaTime);
